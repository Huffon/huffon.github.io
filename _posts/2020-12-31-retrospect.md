...
워낙 살아온 경험이 현재 몸 담고 있는 분야와 이질적이기도 하고, 여러 변화를 주었던 이력들에 대한 부정적 피드백도 많이 받아왔었으니 말이다. 그러던 중 운영하는 페이지를 좋게 봐주던 누군가로부터 인턴 제안을 받게 되었다. 대학원 진학 이전에 작은 규모의 연구를 같이 해볼 의향이 있냐는 제안이었고, 관련 주제로 인턴 주제를 발제하고 전형을 거쳐 **카카오브레인**에 **인턴**으로 단기 근무를 하게 되었다.
...
실체있는 기술을 만들고 싶다는 팀원들 간 _aligned_ 된 믿음도 있고, 이를 위해 다방면으로 허슬을 하고 있는 현재의 팀 분위기도 너무 좋다. 배움의 욕심이 많은 나를 이해해주고, 함께 배움을 좇는 동료들이 있다는 것도 좋은 일이고.
